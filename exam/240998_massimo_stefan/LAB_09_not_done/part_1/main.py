...
if __name__ == "__main__":
    models = [(LM_LSTM_Dropout,
                {"emb_size": 350, "hidden_size": 600, "optimizer": "SGD", "lr": 0.15}),
            (LM_LSTM_Dropout,
                {"emb_size": 300, "hidden_size": 600, "optimizer": "SGD", "lr": 0.12}),
            (LM_LSTM_Dropout,
                {"emb_size": 300, "hidden_size": 600, "optimizer": "SGD", "lr": 0.15})
    ]
