...
if __name__ == "__main__":
    hyp = {"emb_size": 400, "hidden_size": 400, "optimizer":torch.optim.AdamW, "lr": 0.0001}
    ...
    model = LM_LSTM_Adv(hyp['emb_size'], hyp['hidden_size'], vocab_len, pad_id=pad_id).to(device)
